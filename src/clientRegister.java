...
public class clientRegister {
	...
	public static void main(String args[]) throws Exception{
    	...
    	System.out.println("Welcome to our file-sharing app! To register a file, you will have to enter the filename.");
    	...
    	while (true){
	    	...
	    	System.out.println("If you are done registering, simply write 'exit' instead of a filename.");
